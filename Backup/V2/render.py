...
c=Render()
raise
#hull1 = ConvexHull(ranp(30))
hull2 = sphere(1, num=12)
hull2.move(Vector(1.5,0.5,0.5))


p1 = Polyhedron([hull2])

w = World([p1])
axis = Line(Point(0.5,0.5,0.5), [Vector(1,0,0), Vector(0,1,0), Vector(0,0,1)][0])
